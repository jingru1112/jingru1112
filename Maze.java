...
public class Maze
{
    ...
    public static void main(String[] args)
    {
        int[][] grid = {
            ...
            { START, WALL, EMPTY, EMPTY, EMPTY,  WALL, EMPTY, EMPTY, EMPTY, WALL},
            { WALL,  WALL, EMPTY,  WALL,  WALL, EMPTY, EMPTY,  WALL, EMPTY, WALL},
            { WALL,  EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,  WALL,  WALL, EMPTY,  WALL},
            { WALL,  WALL,  WALL,  WALL,  WALL,  WALL,  WALL,  END,  WALL, WALL},
        };
