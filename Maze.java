...
public class Maze {
    ...
    public static void main(String[] args) {
        int[][] grid = { { EMPTY, START, WALL, EMPTY, WALL, WALL, WALL, WALL, WALL, WALL },
        ...
        System.out.println("Find a solution to get from ^^ to $$, using the characters " + "'" + NORTH + "', '" + EAST
                + "', '" + SOUTH + "' and '" + WEST + "'" + " (for north, east, south and west).");
        ...
        while (!done && charIndex < solutionLength) {
            ...
            System.out
                    .println("Location: (" + currentRow + ", " + currentCol + "), next direction: '" + direction + "'");
            ...
            if (currentRow < 0 || currentCol < 0 || currentRow >= grid.length
        ...
        if (!solved) {
            System.out.println("You have failed to escape. Future archeologists gaze upon your remains in bafflement."); // Did
                                                                                                                         // not
                                                                                                                         // reach
                                                                                                                         // the
                                                                                                                         // end.
